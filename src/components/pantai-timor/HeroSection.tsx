...
export function HeroSection({
  ...
  return (
    <section className="relative w-full h-[100svh] min-h-[720px] flex flex-col items-center justify-center !px-4 !pt-32 !pb-40">
      ...
      <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative z-10 flex w-full max-w-[1400px] flex-col items-center">
        <div className={`${fonts.serif} flex items-center gap-4 md:gap-6 text-[#e3e1da]/40 mb-20 md:mb-32`}>
